...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class RigidbodyFirstPersonController : MonoBehaviour
    {
        ...
        {
            float angle = Vector3.Angle(m_GroundContactNormal, Physics.gravity.normalized * -1);
        ...
        private void RotateView()
        {
            ...
            if (m_IsGrounded || advancedSettings.airControl)
            {
                ...
                Quaternion velRotation = Quaternion.AngleAxis(transform.eulerAngles.y - oldYRotation, Physics.gravity.normalized * -1);
        ...
        private void GroundCheck()
        {
            ...
            {
                m_IsGrounded = false;
                m_GroundContactNormal = Physics.gravity.normalized * -1;
            }
