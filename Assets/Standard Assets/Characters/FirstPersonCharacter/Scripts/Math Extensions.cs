...
public static class MathExtensions
{
    ...
    public static Vector3 absComps(Vector3 v)
    {
        Vector3 absCompVector = new Vector3();
        absCompVector.x = Mathf.Abs(v.x);
        absCompVector.y = Mathf.Abs(v.y);
        absCompVector.z = Mathf.Abs(v.z);
        return absCompVector;
    }
}
