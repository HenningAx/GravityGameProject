...
///// Gloss:
            ...
            float gloss = (_Gloss_var.a*_GlossMultiply);
...
/// Vectors:
            ...
            float4 _Gloss_var = tex2D(_Gloss,TRANSFORM_TEX(i.uv0, _Gloss));
            float roughness = 1.0 - (_Gloss_var.a*_GlossMultiply);
